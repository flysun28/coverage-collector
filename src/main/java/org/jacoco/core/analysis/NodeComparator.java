...
public class NodeComparator implements Comparator<ICoverageNode>, Serializable {
     ...
     *
     * @param second second criterion comparator
     * @return composite comparator
     */
    public org.jacoco.core.analysis.NodeComparator second(final Comparator<ICoverageNode> second) {
        final Comparator<ICoverageNode> first = this;
        return new org.jacoco.core.analysis.NodeComparator(null, null) {
     ...
     * elements.
     *
     * @param <T>       actual type of the elements
     * @param summaries collection to create a copy of
     * @return sorted copy
     */
