...
public class CounterComparator implements Comparator<ICounter>, Serializable {
     ...
     */
    public static final org.jacoco.core.analysis.CounterComparator TOTALITEMS = new org.jacoco.core.analysis.CounterComparator(
            CounterValue.TOTALCOUNT);

    /**
     * Compares the absolute number of covered items.
     */
    public static final org.jacoco.core.analysis.CounterComparator COVEREDITEMS = new org.jacoco.core.analysis.CounterComparator(
            CounterValue.COVEREDCOUNT);

    /**
     * Compares the absolute number of missed items.
     */
    public static final org.jacoco.core.analysis.CounterComparator MISSEDITEMS = new org.jacoco.core.analysis.CounterComparator(
            CounterValue.MISSEDCOUNT);

    /**
     * Compares the ratio of covered items.
     */
    public static final org.jacoco.core.analysis.CounterComparator COVEREDRATIO = new org.jacoco.core.analysis.CounterComparator(
            CounterValue.COVEREDRATIO);

    /**
     * Compares the ratio of missed items.
     */
    public static final org.jacoco.core.analysis.CounterComparator MISSEDRATIO = new org.jacoco.core.analysis.CounterComparator(
    ...
    public org.jacoco.core.analysis.CounterComparator reverse() {
        return new org.jacoco.core.analysis.CounterComparator(value, !reverse);
    }
     ...
     *
     * @param entity counter entity to sort on
