...
public class CoverageNodeImpl implements ICoverageNode {
     ...
     *
     * @param elementType type of the element represented by this instance
    ...
    public ICoverageNode getPlainCopy() {
        final org.jacoco.core.analysis.CoverageNodeImpl copy = new org.jacoco.core.analysis.CoverageNodeImpl(elementType, name);
