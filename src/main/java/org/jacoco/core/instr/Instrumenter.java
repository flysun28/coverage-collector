...
public class Instrumenter {
     ...
     *
     * @param runtime runtime used by the instrumented classes
     */
     ...
     * @throws IOException if the class can't be instrumented
     */
     ...
     * @param name  a name used for exception messages
     * @return instrumented definition
     * @throws IOException if reading data from the stream fails or the class can't be
     *                     instrumented
     */
     ...
     * @throws IOException if reading data from the stream fails or a class can't be
     *                     instrumented
     */
