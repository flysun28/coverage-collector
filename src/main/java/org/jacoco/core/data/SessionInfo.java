 ...
 * {@link org.jacoco.core.data.SessionInfo} instances can be sorted by dump date through the
 * {@link Comparable} interface.
 */
public class SessionInfo implements Comparable<org.jacoco.core.data.SessionInfo> {
    ...
    public int compareTo(final org.jacoco.core.data.SessionInfo other) {
