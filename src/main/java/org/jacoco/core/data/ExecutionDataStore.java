...
public final class ExecutionDataStore implements IExecutionDataVisitor {
     ...
     * @throws IllegalStateException if the given {@link ExecutionData} object is not compatible
     ...
     */
    public void subtract(final org.jacoco.core.data.ExecutionDataStore store) {
