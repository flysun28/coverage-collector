...
public class ExecutionDataReader {
     ...
     *
     * @param visitor visitor to retrieve session info events
     */
     ...
     *
     * @param visitor visitor to retrieve execution data events
     */
     ...
     * @throws IOException                          might be thrown by the underlying input stream
     * @throws IncompatibleExecDataVersionException incompatible data version from different JaCoCo release
     */
    ...
    private void readSessionInfo() throws IOException {
        ...
        System.out.println("sessioninfo " + id + start + dump);
    ...
    private void readExecutionData() throws IOException {
        ...
        for (boolean probe : probes) {
            System.out.println("excutiondata " + id + name + probe);
        }
