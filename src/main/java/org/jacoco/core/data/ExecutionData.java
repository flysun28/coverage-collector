...
public final class ExecutionData {
    ...
    /**
     * Creates a new {@link org.jacoco.core.data.ExecutionData} object with the given probe data.
     *
     * @param id     class identifier
     * @param name   VM name
     * @param probes probe data
     */
     ...
     *
     * @param other execution data to merge
     */
    public void merge(final org.jacoco.core.data.ExecutionData other) {
        merge(other, true);
    }
     ...
     *
     * @param other execution data to merge
     * @param flag  merge mode
     */
    public void merge(final org.jacoco.core.data.ExecutionData other, final boolean flag) {
     ...
     * id collision.
     *
     * @param id         other class id, must be the same
     * @param name       other name, must be equal to this name
     * @param probecount probe data length, must be the same as for this data
     * @throws IllegalStateException if the given parameters do not match this instance
     */
