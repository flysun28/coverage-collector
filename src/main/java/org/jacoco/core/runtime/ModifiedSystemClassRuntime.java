...
public class ModifiedSystemClassRuntime extends AbstractRuntime {
     ...
     *
     * @param systemClass     system class that contains the execution data
     * @param accessFieldName name of the public static runtime access field
     */
    ...
    /**
     * Creates a new {@link org.jacoco.core.runtime.ModifiedSystemClassRuntime} using the given class as
     ...
     * @param className VM name of the class to use
     * @return new runtime instance
     * @throws ClassNotFoundException id the given class can not be found
     */
     ...
     * @param inst            instrumentation interface
     * @param className       VM name of the class to use
     * @param accessFieldName name of the added runtime access field
     * @return new runtime instance
    ...
    public static IRuntime createFor(final Instrumentation inst,
        ...
        return new org.jacoco.core.runtime.ModifiedSystemClassRuntime(clazz, accessFieldName);
    }

    /**
     * Adds the static data field to the given class definition.
     *
     * @param source          class definition source
     * @param accessFieldName name of the runtime access field
