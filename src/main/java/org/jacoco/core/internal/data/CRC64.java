...
public final class CRC64 {
     ...
     *
     * @param sum                initial checksum value
     * @param bytes              byte array to update the checksum with
     * @param fromIndexInclusive start index in array, inclusive
     * @param toIndexExclusive   end index in array, exclusive
     * @return updated checksum value
     */
