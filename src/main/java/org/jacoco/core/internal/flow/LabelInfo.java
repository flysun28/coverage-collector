...
public final class LabelInfo {
    ...
    public static void setTarget(final Label label) {
        final org.jacoco.core.internal.flow.LabelInfo info = create(label);
    ...
    public static boolean isMultiTarget(final Label label) {
        final org.jacoco.core.internal.flow.LabelInfo info = get(label);
     ...
     *
     * @param label label to assign a probe to
     ...
     *
     * @param label        label to define for
     * @param intermediate intermediate label
     */
     ...
     *
     * @param label       label to set the instruction for
     * @param instruction corresponding instruction
     */
    ...
    private static org.jacoco.core.internal.flow.LabelInfo get(final Label label) {
        final Object info = label.info;
        return info instanceof org.jacoco.core.internal.flow.LabelInfo ? (org.jacoco.core.internal.flow.LabelInfo) info : null;
    }

    private static org.jacoco.core.internal.flow.LabelInfo create(final Label label) {
        org.jacoco.core.internal.flow.LabelInfo info = get(label);
        if (info == null) {
            info = new org.jacoco.core.internal.flow.LabelInfo();
            label.info = info;
        }
        return info;
    }
