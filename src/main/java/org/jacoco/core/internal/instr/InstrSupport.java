...
public final class InstrSupport {
     ...
     * offset 6).
     *
     * @param majorVersion major version of bytecode to set
     * @param b            bytes of class
     ...
     *
     * @param reader reader to get information about the class
     * @return major version of bytecode
     ...
     * @throws IllegalStateException thrown if the member has the same name than the
