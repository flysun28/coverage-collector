...
public class SignatureRemover {
     ...
     *
     * @param active <code>true</code> if it should remove signature related
     *               entries.
     */
     ...
     *
     * @param name path name of the entry in question
     ...
     *
     * @param name path name of the entry in question
     * @param in   source for the element to filter
     * @param out  output for the filtered contents
     * @return <code>true</code> if the content was filtered
     * @throws IOException if the content can't be read or written
     */
