...
public final class Filters implements IFilter {
     ...
     */
    public static final IFilter NONE = new org.jacoco.core.internal.analysis.filter.Filters();
    ...
    public static IFilter all() {
        return new org.jacoco.core.internal.analysis.filter.Filters(new EnumFilter(), new SyntheticFilter(),
