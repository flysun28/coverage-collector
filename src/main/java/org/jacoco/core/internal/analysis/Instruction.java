 ...
 * <p>
 * For each bytecode instruction of a method a {@link org.jacoco.core.internal.analysis.Instruction} instance is
 ...
 * CFG edges ({@link #addBranch(org.jacoco.core.internal.analysis.Instruction, int)}).
 *
 ...
 * instructions. Note that these methods create new {@link org.jacoco.core.internal.analysis.Instruction}
 * instances and do not modify the existing ones.
 *
 * <ul>
 * <li>{@link #merge(org.jacoco.core.internal.analysis.Instruction)}</li>
...
public class Instruction {
     ...
     */
    public void addBranch(final org.jacoco.core.internal.analysis.Instruction target, final int branch) {
        branches++;
    ...
    private static void propagateExecutedBranch(org.jacoco.core.internal.analysis.Instruction insn, int branch) {
     ...
     */
    public org.jacoco.core.internal.analysis.Instruction merge(final org.jacoco.core.internal.analysis.Instruction other) {
        final org.jacoco.core.internal.analysis.Instruction result = new org.jacoco.core.internal.analysis.Instruction(this.line);
     ...
     */
    public org.jacoco.core.internal.analysis.Instruction replaceBranches(
            final Collection<org.jacoco.core.internal.analysis.Instruction> newBranches) {
        final org.jacoco.core.internal.analysis.Instruction result = new org.jacoco.core.internal.analysis.Instruction(this.line);
        result.branches = newBranches.size();
        int idx = 0;
        for (final org.jacoco.core.internal.analysis.Instruction b : newBranches) {
