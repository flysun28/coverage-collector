...
public interface IFilterOutput {
     ...
     * of coverage.
     *
     * @param fromInclusive first instruction that should be ignored, inclusive
     * @param toInclusive   last instruction coming after <code>fromInclusive</code> that
     ...
     *
     * @param source     instruction which branches should be replaced
     * @param newTargets new targets of branches
     */
