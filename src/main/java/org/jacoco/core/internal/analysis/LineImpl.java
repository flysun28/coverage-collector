...
public abstract class LineImpl implements ILine {
    ...
    private static final org.jacoco.core.internal.analysis.LineImpl[][][][] SINGLETONS = new org.jacoco.core.internal.analysis.LineImpl[SINGLETON_INS_LIMIT + 1][][][];

    static {
        for (int i = 0; i <= SINGLETON_INS_LIMIT; i++) {
            SINGLETONS[i] = new org.jacoco.core.internal.analysis.LineImpl[SINGLETON_INS_LIMIT + 1][][];
            for (int j = 0; j <= SINGLETON_INS_LIMIT; j++) {
                SINGLETONS[i][j] = new org.jacoco.core.internal.analysis.LineImpl[SINGLETON_BRA_LIMIT + 1][];
                for (int k = 0; k <= SINGLETON_BRA_LIMIT; k++) {
                    SINGLETONS[i][j][k] = new org.jacoco.core.internal.analysis.LineImpl[SINGLETON_BRA_LIMIT + 1];
     ...
     */
    public static final org.jacoco.core.internal.analysis.LineImpl EMPTY = SINGLETONS[0][0][0][0];

    private static org.jacoco.core.internal.analysis.LineImpl getInstance(final CounterImpl instructions,
    ...
    private static final class Var extends org.jacoco.core.internal.analysis.LineImpl {
        ...
        @Override
        public org.jacoco.core.internal.analysis.LineImpl increment(final ICounter instructions,
     ...
     */
    public abstract org.jacoco.core.internal.analysis.LineImpl increment(final ICounter instructions,
                                                                         final ICounter branches);
