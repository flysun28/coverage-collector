...
public abstract class CounterImpl implements ICounter {
    ...
    private static final org.jacoco.core.internal.analysis.CounterImpl[][] SINGLETONS = new org.jacoco.core.internal.analysis.CounterImpl[SINGLETON_LIMIT + 1][];

    static {
        for (int i = 0; i <= SINGLETON_LIMIT; i++) {
            SINGLETONS[i] = new org.jacoco.core.internal.analysis.CounterImpl[SINGLETON_LIMIT + 1];
     ...
     */
    public static final org.jacoco.core.internal.analysis.CounterImpl COUNTER_0_0 = SINGLETONS[0][0];

    /**
     * Constant for Counter with 1/0 values.
     */
    public static final org.jacoco.core.internal.analysis.CounterImpl COUNTER_1_0 = SINGLETONS[1][0];

    /**
     * Constant for Counter with 0/1 values.
     */
    public static final org.jacoco.core.internal.analysis.CounterImpl COUNTER_0_1 = SINGLETONS[0][1];
    ...
    private static class Var extends org.jacoco.core.internal.analysis.CounterImpl {
        ...
        @Override
        public org.jacoco.core.internal.analysis.CounterImpl increment(final int missed, final int covered) {
            this.missed += missed;
     ...
     *
     * @param missed  number of missed items
     * @param covered number of covered items
     * @return counter instance
     */
    public static org.jacoco.core.internal.analysis.CounterImpl getInstance(final int missed, final int covered) {
     ...
     *
     * @param counter counter to copy
     * @return counter instance
     */
    public static org.jacoco.core.internal.analysis.CounterImpl getInstance(final ICounter counter) {
     ...
     */
    public org.jacoco.core.internal.analysis.CounterImpl increment(final ICounter counter) {
     ...
     * @return counter instance with incremented values
     */
    public abstract org.jacoco.core.internal.analysis.CounterImpl increment(int missed, int covered);
