...
public class ClassCoverageImpl extends SourceNodeImpl implements IClassCoverage {
     ...
     * @param noMatch <code>true</code>, if class id does not match with execution
     *                data
     */
     ...
     *
     * @param signature VM signature of the class (may be <code>null</code>)
     */
     ...
     *
     * @param superName VM name of the super class (may be <code>null</code>, i.e.
     ...
     *
     * @param interfaces VM names of implemented/extended interfaces
     */
