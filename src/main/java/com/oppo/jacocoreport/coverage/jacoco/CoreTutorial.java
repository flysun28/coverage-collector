...
public final class CoreTutorial {
    private final static Logger LOG = Logger.getLogger(CoreTutorial.class.getName());
    /**
...
//        final String targetName = TestTarget.class.getName();
        final String targetName = "D:\\codeCoverage\\10010\\classes\\com\\oppo\\fintech\\loan\\api\\annotation\\Login.class";
...
//             LOG.info(String.format("instrumented[%d] == %x",i,instrumented[i]));
//        }
        original.close();
...
//        }
        ...
        try{
            fileOutputStream = new FileOutputStream("instrumented.class");
            fileOutputStream.write(instrumented);
        }catch (IOException e){
            e.printStackTrace();
        }finally {
...
//            return getClass().getResourceAsStream(resource);
    ...
    public static void main(final String[] args) throws Exception {
        new CoreTutorial(System.out).instrumentClass();
    }
