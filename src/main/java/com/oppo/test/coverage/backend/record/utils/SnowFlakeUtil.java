...
package com.oppo.test.coverage.backend.record.utils;
...
public class SnowFlakeUtil {
    ...
    public static String getSnowId(long datacenterId,long machineId){
        SnowFlakeUtil snowFlakeUtil = new SnowFlakeUtil(datacenterId,machineId);
        return String.valueOf(snowFlakeUtil.getNextId());
    }
}
