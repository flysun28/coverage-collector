...
public class FolderFileScanner {
     ...
     * 下载之后,解压目录下的zip
     */
    private static void unZipAfterDownload(String zipFileName) {
        // /home/service/app/coveragebackend/xxxxx/taskID/${taskId}/classes/xxx.zip
        FileOperateUtil.unZipFiles(zipFileName, zipFileName.replace("/upload.zip", ""), true);
    }
