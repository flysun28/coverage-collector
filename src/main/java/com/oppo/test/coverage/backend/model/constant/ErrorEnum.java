...
public enum ErrorEnum {
    ...
    GET_ENVIRONMENT_IP(1002,"获取测试环境IP失败,请确认配置的版本是否部署测试环境"),
    ...
    GET_DOWNLOAD_PACKAGE_FAILED(1007,"未找到本版本的部署包,请确认配置的版本是否部署测试环境"),
    DOWNLOAD_BUILD_VERSION_FAILED(1008,"网络问题导致下载版本包失败，请重新执行一次"),
